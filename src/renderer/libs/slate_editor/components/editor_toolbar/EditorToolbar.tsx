            ...
            return (
              <div className="block">
                <SquareIconButton
                  ...
                  unFocusable
                  iconColor={
                    isMarkActive(editor, 'bold') ? color.white : color.light
                  }
                  Icon={BoldIcon}
                />
                <SquareIconButton
                  ...
                  unFocusable
                  iconColor={
                    isMarkActive(editor, 'italic') ? color.white : color.light
                  }
                  Icon={ItalicIcon}
                />
                <SquareIconButton
            ...
            return (
              <div className="block">
                <SquareIconButton
                  ...
                  unFocusable
                  iconColor={
                    isAlignActive(editor, 'left') ? color.white : color.light
                  }
                  Icon={AlignLeft}
                />
                <SquareIconButton
                ...
                <SquareIconButton
                  ...
                  unFocusable
                  iconColor={
                    isAlignActive(editor, 'right') ? color.white : color.light
                  }
                  Icon={AlignRight}
                />
              </div>
                        ...
                        <ImageGallery
                          onSelect={async (image) => {
                            ...
                            const height = Math.floor(
                              (250 * img.height) / img.width,
                            );
                            ImageEditor.insertImage(editor, image, {
                              width,
                              height,
                            });
