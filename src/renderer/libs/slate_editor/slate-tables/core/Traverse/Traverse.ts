...
export class Traverse {
  ...
  static create(editor: Editor, cellLocation: Location) {
    ...
    let currentTableEntry: NodeEntry<TableElement> | undefined = undefined;
    let currentRowEntry: NodeEntry<TableRowElement> | undefined = undefined;
    let currentCellEntry: NodeEntry<TableCellElement> | undefined =
      editor.isTableCellNode(cellNode) ? [cellNode, cellPath] : undefined;
